...
<body>
	...
	<table width="100%" height="100%">
		<tr>
			...
			<td></td>
			<td width="190">
				<a href="http://203.249.87.55/redmine" target="main_bottom">Project Management</a>
			</td>
			<td width="200">
				<a href="http://203.249.87.55/jenkins" target="main_bottom">Continuous Integration</a>
			</td>
			<td width="130">
